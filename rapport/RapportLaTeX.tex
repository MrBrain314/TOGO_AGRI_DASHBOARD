...
\begin{titlepage}
    ...
    \begin{tabular}{ll}
        ...
        \textbf{Outil :} & Dashboard Streamlit interactif \\
         \textbf{Dashboard en ligne :} & \href{https://togo-agri-dashboard.streamlit.app/}{togo-agri-dashboard.streamlit.app} \\
    \end{tabular}
...
\noindent Le tableau de bord interactif développé dans le cadre de ce travail est accessible en ligne à l'adresse suivante :
\begin{center}
    \href{https://togo-agri-dashboard.streamlit.app/}{\texttt{https://togo-agri-dashboard.streamlit.app/}}
\end{center}
